...
### Team Colors (Official Pokémon GO Teams)
- **Valor (Red)**: `#dc2626` - Fire-themed, flame icon
- **Mystic (Blue)**: `#2563eb` - Ice-themed, shield icon  
- **Instinct (Yellow)**: `#eab308` - Lightning-themed, zap icon
- **Neutral (Gray)**: `#64748b` - No team preference

## Team Glow Effects
Each raid lobby card displays a subtle glow effect matching the controlling team:
...
- Boss selection as scrollable visual grid with Pokémon images
...
**Permitted Pokémon GO Content**:
- Current raid Pokémon names and images (from PokémonDB)
- Official team names: Valor, Mystic, Instinct
- This is the ONLY permitted copyrighted content

**Original Content**:
- App branding (GO Raiders name, volcanic logo)
